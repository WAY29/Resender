...
const messages = {
  en: {
    ...
    contextMenu: {
      ...
      openInSourcesFailed: "DevTools could not open this resource in Sources.",
      ...
      copyAsFetchNode: "Copy as fetch (Node.js)",
      ...
      copyAllListedAsFetchNode: "Copy all listed as fetch (Node.js)",
    ...
    details: {
      ...
      previewNotSupported: "This response type is not supported in Preview yet.",
      ...
      searchMatchCount: (current: number, total: number) => `${current} of ${total}`,
  ...
  zh: {
    ...
    contextMenu: {
      ...
      copy: "复制",
      filter: "过滤",
      openInSources: "在 Sources 中打开",
      openInSourcesFailed: "DevTools 无法在 Sources 中打开这个资源。",
      openInNewTab: "在新标签页中打开",
      copyUrl: "复制 URL",
      copyAllListedUrls: "复制所有已列出 URL",
      copyAsCurlBash: "复制为 cURL (bash)",
      copyAsCurlCmd: "复制为 cURL (cmd)",
      copyAsPowerShell: "复制为 PowerShell",
      copyAsFetch: "复制为 fetch",
      copyAsFetchNode: "复制为 fetch (Node.js)",
      copyAllListedAsCurlBash: "复制所有已列出项为 cURL (bash)",
      copyAllListedAsCurlCmd: "复制所有已列出项为 cURL (cmd)",
      copyAllListedAsPowerShell: "复制所有已列出项为 PowerShell",
      copyAllListedAsFetch: "复制所有已列出项为 fetch",
      copyAllListedAsFetchNode: "复制所有已列出项为 fetch (Node.js)",
      filterByDomain: "按域名过滤",
      filterByMethod: "按方法过滤",
      hideFromList: "从列表中隐藏"
    },
    details: {
      closeDetails: "关闭详情",
      ...
      previewNotSupported: "此响应类型暂不支持预览",
      addHeader: "添加 Header",
      ...
      noMatches: "无结果",
      invalidRegex: "正则无效",
      searchMatchCount: (current: number, total: number) => `${current} 个（共 ${total} 个）`,
